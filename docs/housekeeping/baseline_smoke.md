...
- In-repo gallery snapshot (same run): `docs/ui_gallery/index.html`.
...
- Genymotion PDF form fill smoke: `./scripts/geny_pdf_form_fill_smoke.sh` – **PASS**.
- Genymotion PDF form widgets smoke: `./scripts/geny_pdf_form_widgets_smoke.sh` – **PASS**.
- Genymotion PDF form navigation smoke: `./scripts/geny_pdf_form_nav_smoke.sh` – **PASS**.
- Genymotion PDF advanced choice smoke: `./scripts/geny_pdf_form_choice_advanced_smoke.sh` – **PASS**.
...
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.
- Genymotion pinch-zoom smoke: `./scripts/geny_pinch_zoom_smoke.sh` – **PASS**.
- Genymotion PDF text-annot smoke: `./scripts/geny_pdf_text_annot_smoke.sh` – **PASS**.

## Update – 2025-12-28 (Gestures: pan in add-text mode)
- Commit: `1d0d5a4f`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-28 (Zoom: pinch-zoom stability)
- Commit: `b3f0ae4d`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion pinch-zoom smoke: `./scripts/geny_pinch_zoom_smoke.sh` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
...
## Update – 2025-12-28 (PDF FreeText: harden tap/edit after idle)
- Commit: `9668ac55`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.
- Genymotion PDF text-annot smoke: `./scripts/geny_pdf_text_annot_smoke.sh` – **PASS** (includes a “tap-to-edit after idle” step; set `POST_EDIT_IDLE_TAP_S=0` to disable).

## Update – 2025-12-28 (PDF FreeText: apply style (font size + color))
- Commit: `c74e26bd`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Linux smoke: `./scripts/linux_smoke.sh` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
...
## Update – 2025-12-28 (PDF FreeText: move selected text)
- Commit: `aa70071b`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Linux smoke: `./scripts/linux_smoke.sh` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
...
## Update – 2025-12-28 (PDF FreeText: tap-to-select, second-tap edit)
- Commit: `a3db2fda`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.
...
## Update – 2025-12-28 (Sidecar notes: visible text + toolbar edit)
- Commit: `6f370082`.
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS** (includes note OCR; set `ASSERT_NOTE_OCR=0` to disable).
- Genymotion PDF text-annot smoke: `./scripts/geny_pdf_text_annot_smoke.sh` – **PASS**.
...
## Update – 2025-12-25 (Linux: pp_core L4 markup/text annots + enumerate)
- Commit: `b3db49d0`.
- Linux smoke: `./scripts/linux_smoke.sh` – **PASS** (includes `pp_demo --annot-smoke`: highlight + free text → save-as → reopen → render + enumerate).
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-25 (Linux: pp_core L4 ink annotations)
- Commit: `b9657202`.
- Linux smoke: `./scripts/linux_smoke.sh` – **PASS** (includes `pp_demo --ink-smoke`: ink → save-as → reopen → render).
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-25 (Linux: pp_core L3 cache + cookie abort)
- Commit: `1e3c999f`.
- Linux smoke: `./scripts/linux_smoke.sh` – **PASS** (includes `pp_demo --cancel-smoke`).
- Android build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-25 (Refactor: gesture zone annotation hit helper)
- Commit: `23d15790`.
...
## Update – 2025-12-24 (Refactor: MuPDFReaderView interaction controller)
- Commit: `d6fdb6d5`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: composition-owned editor prefs)
- Commit: `82e87916`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: page text annotation requester)
- Commit: `2c64e163`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: PageView mode requester)
- Commit: `9f5f9a01`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: ReaderView detector ownership)
- Commit: `3bb9a87d`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: ReaderView gesture host)
- Commit: `787399ae`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: gesture zone package move)
- Commit: `f68d3986`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Gesture: link tap navigation)
- Commit: `055fd89c`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: Phase 2 closure)
- Commit: `6b92c4a5`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: Phase 2 host adapters)
- Commit: `d255ca25`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: toolbar state owners)
- Commit: `99b325ed`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.
...
## Update – 2025-12-24 (Refactor: page tap hit routing)
- Commit: `e1203482`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: link hit-testing delegation)
- Commit: `e6dcf3ef`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: selection action coordination)
- Commit: `4081b3b5`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: sidecar selection actions)
- Commit: `4f264ee6`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.

## Update – 2025-12-24 (Refactor: sidecar selection controller)
- Commit: `2b656b7e`.
- Build: `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**.
- Genymotion PDF smoke: `./scripts/geny_smoke.sh` – **PASS**.
- Genymotion EPUB smoke: `./scripts/geny_epub_smoke.sh` – **PASS**.
...
- Genymotion PDF Save embeds ink smoke (Pixel 6 / Android 13 @ `localhost:42865`): `./scripts/geny_pdf_save_embeds_ink_smoke.sh` – **PASS**.
...
## Update – 2025-12-28 (Release: 1.3.58)
...
## Update – 2025-12-28 (Release: 1.3.59)

### Builds
- `cd platform/android && ./gradlew testDebugUnitTest assembleDebug -x lint` – **PASS**
- `scripts/fdroid_build.sh` – **PASS** (signed release; runs R8 + lintVitalRelease)

### Smokes
- `scripts/geny_release_crash_watch_smoke.sh` – **PASS** (installs `org.opendroidpdf_120.apk` and waits)
...
## Update – 2025-12-28 (Release: 1.3.60)

### Builds
- `scripts/fdroid_build.sh` – **PASS** (signed release; runs R8 + lintVitalRelease)

### Smokes
- `scripts/geny_release_crash_watch_smoke.sh` – **PASS** (installs `org.opendroidpdf_121.apk` and waits)
