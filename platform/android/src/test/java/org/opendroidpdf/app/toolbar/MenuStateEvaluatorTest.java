...
public class MenuStateEvaluatorTest {
    ...
    public void noDocument_HidesAndDisablesEverything() {
        MenuStateEvaluator.Inputs in = new MenuStateEvaluator.Inputs(false, false, false, false, false, false, false, false);
        ...
        assertFalse(s.redoVisible);
        assertFalse(s.redoEnabled);
    ...
    public void openDoc_NoUndo_NoUnsaved_NoLink_ShowsBasics() {
        MenuStateEvaluator.Inputs in = new MenuStateEvaluator.Inputs(true, false, false, false, false, true, false, true);
        MenuState s = MenuStateEvaluator.compute(in);
    ...
    public void openDoc_AllCapabilities_EnableAll() {
        MenuStateEvaluator.Inputs in = new MenuStateEvaluator.Inputs(true, true, true, true, true, true, false, true);
        MenuState s = MenuStateEvaluator.compute(in);
        assertTrue(s.undoVisible);
        assertTrue(s.undoEnabled);
        assertTrue(s.redoVisible);
        assertTrue(s.redoEnabled);
        assertTrue(s.saveEnabled);
    ...
    public void openDoc_SaveNotSupported_HidesSave() {
        MenuStateEvaluator.Inputs in = new MenuStateEvaluator.Inputs(true, false, false, false, false, false, true, false);
        MenuState s = MenuStateEvaluator.compute(in);
        assertFalse(s.saveEnabled);
    ...
    public void openPdf_NoWriteAccess_HidesSaveKeepsExport() {
        MenuStateEvaluator.Inputs in = new MenuStateEvaluator.Inputs(true, false, false, false, false, true, false, false);
        MenuState s = MenuStateEvaluator.compute(in);
        assertFalse(s.saveEnabled);
        assertTrue(s.searchVisible);
        assertTrue(s.drawVisible);
