...
public class EditorPreferences {
    ...
    public EditorPreferences(Context context) {
        ...
        this.penPreferences = new PenPreferences(this.context);
    }
    ...
    // Pen settings
    public float getInkThickness() { return penPreferences.getThickness(); }
    public void setInkThickness(float value) { penPreferences.setThickness(value); }
    public int getInkColorHex() { return ColorPalette.getHex(penPreferences.getColorIndex()); }
