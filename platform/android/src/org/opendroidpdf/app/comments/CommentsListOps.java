...
final class CommentsListOps {

    enum Backend { EMBEDDED, SIDECAR }

    enum Bucket { NOTE, TEXT_BOX, MARKUP, INK, OTHER }
    ...
    @NonNull
    static List<CommentEntry> loadComments(@NonNull MuPdfRepository repo,
