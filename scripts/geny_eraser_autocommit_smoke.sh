...
#
# Usage:
#   DEVICE=localhost:<port> APK=/path/to/OpenDroidPDF-debug.apk ./scripts/geny_eraser_autocommit_smoke.sh
...
for attempt in 1 2 3 4 5 6 7 8; do
  ...
  if BASELINE="$BASELINE" OCR_TXT="$OCR_TXT" OCR_NEEDLES="$OCR_NEEDLES" python - <<'PY'
