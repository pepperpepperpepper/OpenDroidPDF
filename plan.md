...
4) **Vision QA** – summarize emulator screenshots with `scripts/screenshot_check.sh "tmp_geny_*.png" vision_notes.md` (Codex vision). Capture stroke thickness vs text/blank-page status after smokes.
