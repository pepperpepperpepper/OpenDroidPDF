...
- F-Droid: deployed `1.3.67 (128)` on 2026-01-06 via `./scripts/fdroid_build.sh` + `./scripts/fdroid_deploy.sh` (repo: `https://fdroid.uh-oh.wtf/repo`).
...
- 2026-01-06: F-Droid: deployed `1.3.67 (128)` to `https://fdroid.uh-oh.wtf/repo` (OpenDroidPDF + Office Pack). Verified: `./scripts/fdroid_build.sh` + `./scripts/fdroid_deploy.sh` (PASS; repo shows `versionName=1.3.67 versionCode=128`).
