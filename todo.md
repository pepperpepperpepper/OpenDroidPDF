...
- 2025-12-24: Decoupled navigation controllers from the concrete activity type by removing `OpenDroidPDFActivity` usage from `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/app/document/DocumentNavigationController.java` and `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/app/navigation/NavigationDelegate.java`. Commit: `ca7e4de4`.
- 2025-12-24: Removed the concrete activity dependency from `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/app/document/DocumentViewDelegate.java` via a new host contract and `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/app/hosts/DocumentViewDelegateHostAdapter.java`. Commit: `8f5aa3b2`.
- 2025-12-24: Phase 2 slice: removed remaining non-host `OpenDroidPDFActivity` dependencies from lifecycle/debug/back-press/intent-resume/setup paths by introducing narrow `Host` contracts and adapters under `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/app/hosts/` and delegating from `/mnt/subtitled/repos/penandpdf/platform/android/src/org/opendroidpdf/OpenDroidPDFActivity.java`. Commit: `d255ca25`.
